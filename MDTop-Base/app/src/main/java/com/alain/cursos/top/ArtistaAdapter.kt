...
class ArtistaAdapter internal constructor(private var artistas: MutableList<Artista>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imgFoto?.let { imgPhoto ->
            holder.tvNombre?.let { tvNombre ->
                holder.setListener(artista, imgPhoto, tvNombre, listener)
            }
        }
        holder.tvNombre!!.text = artista.nombreCompleto
        holder.tvNote!!.text = artista.notas
    ...
    inner class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        var tvNote: AppCompatTextView? = null
        ...
        fun setListener(artista: Artista, imagePhoto: View, tvName: View, listener: OnItemClickListener) {
            containerMain!!.setOnClickListener { view: View? ->
                //listener.onItemClick(artista)
                this@ArtistaAdapter.listener.onItemClick(artista, imagePhoto, tvName)}
            containerMain!!.setOnLongClickListener { view: View? ->
                this@ArtistaAdapter.listener.onLongItemClick(artista)
                true
            }
        }
