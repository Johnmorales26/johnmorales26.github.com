...
class MainActivity : AppCompatActivity(), OnItemClickListener {
    ...
    private var SP_DARK_THEME: String = "spDarkTheme"
    private lateinit var mSharedPreferences: SharedPreferences
    private var mIsModeNight: Boolean? = null
    ...
    private fun generateArtist() {
        ...
        val fotos = arrayOf("https://live.staticflickr.com/8167/28530213082_926d57d5c9_b.jpg",
        ...
        for (i in nombres.indices) {
            val artista = Artista(nombres[i], apellidos[i], nacimientos[i], lugares[i],
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        mIsModeNight?.let { editor.putBoolean(SP_DARK_THEME, it) }
        editor.apply()
    ...
    override fun onItemClick(artista: Artista?, imgPhoto: View, tvName: View) {
        val intent = Intent(this@MainActivity, DetalleActivity::class.java)
        intent.putExtra(Artista.ID, artista!!.id)
        //startActivity(intent)
        //startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle())
        val imgPair: Pair<View, String> = Pair.create(imgPhoto, imgPhoto.getTransitionName())
        /*val notePair: Pair<View, String> = Pair.create(tvNote, tvNote.getTransitionName())
        val orderPair: Pair<View, String> = Pair.create(tvOrder, tvOrder.getTransitionName())*/
        val namePair: Pair<View, String> = Pair.create(tvName, tvName.getTransitionName())
        /*val options = ActivityOptions
            .makeSceneTransitionAnimation(this, view, getString(R.string.transition_name_photo))
            .toBundle()*/
        val options = ActivityOptions
    ...
    fun addArtist() {
        ...
        startActivityForResult(intent, 1, ActivityOptions
