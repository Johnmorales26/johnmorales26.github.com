...
import com.example.supercalculadora.databinding.ActivityDiscountBinding
...
class DiscountActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCalculate.setOnClickListener{
            if (validFields()){
                ...
                with(binding){
                    tvValueResult.text = algebra.discountTotal(valueA, valueB)
                ...
                binding.btnViewOperation.setOnClickListener {
                    ...
                    binding.tvOperations.text = algebra.Operationdiscount(valueA, valueB)
                }
    ...
    private fun stringFormat(text: String): String{
        return "$-{text}"
    }
}