...
import com.example.supercalculadora.databinding.ActivitySimplePercentBinding
import com.example.supercalculadora.functionscalculator.Algebra

class SimplePercentActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimplePercentBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimplePercentBinding.inflate(layoutInflater)
        ...
        binding.btnCalculate.setOnClickListener{
            if (validFields()){
                ...
                with(binding){
                    tvValueResult.text = algebra.simplePercent(valueA, valueB)
                ...
                binding.btnViewOperation.setOnClickListener {
                    ...
                    binding.tvOperations.text = algebra.simplePercentOperation(valueA, valueB)
                }
