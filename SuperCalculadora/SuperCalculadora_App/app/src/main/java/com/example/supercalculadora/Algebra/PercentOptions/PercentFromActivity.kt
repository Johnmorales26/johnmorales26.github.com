...
import com.example.supercalculadora.databinding.ActivityPercentFromBinding
import com.example.supercalculadora.functionscalculator.Algebra

class PercentFromActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPercentFromBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPercentFromBinding.inflate(layoutInflater)
        ...
        binding.btnCalculate.setOnClickListener{
            if (validFields()){
                ...
                with(binding){
                    tvValueResult.text = algebra.percentOfAsinceB(valueA, valueB)
                ...
                binding.btnViewOperation.setOnClickListener {
                    ...
                    binding.tvOperations.text = algebra.percentOfAsinceBOperation(valueA, valueB)
                }
