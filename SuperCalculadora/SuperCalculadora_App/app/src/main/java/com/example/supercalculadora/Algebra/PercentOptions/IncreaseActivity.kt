...
import com.example.supercalculadora.databinding.ActivityIncreaseBinding
import com.example.supercalculadora.functionscalculator.Algebra

class IncreaseActivity : AppCompatActivity() {
    private lateinit var binding: ActivityIncreaseBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityIncreaseBinding.inflate(layoutInflater)
        ...
        binding.btnCalculate.setOnClickListener{
            if (validFields()){
                ...
                with(binding){
                    tvValueResult.text = algebra.incrementTotal(valueA, valueB)
                ...
                binding.btnViewOperation.setOnClickListener {
                    ...
                    binding.tvOperations.text = algebra.Operationincrement(valueA, valueB)
                }
