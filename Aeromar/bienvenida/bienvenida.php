...
<head>
    ...
    <link href="./styles_bienvenida.css" rel="stylesheet">
    <title>Document</title>
</head>

<body>
    <h1>
        BIENVENIDO A TU PAGINA PRINCIPAL
    </h1>

    <img src="../Muestras/1.png" width="400" height="100">

    <a href="../sliderVuelo/sliderVuelo.php" class="buttonRegistrar">
        Reservar
    </a>
    <a href="../consulta/consulta.php" class="buttonLogin">
        Consultar
    </a>
