...
//        authorCardBuilder.titleColor(ContextCompat.getColor(c, R.color.colorAccent));
        ...
        authorCardBuilder.addItem(new MaterialAboutActionItem.Builder()
                ...
                .icon(new IconicsDrawable(c)
                        ...
                        .sizeDp(18))
                .setOnClickAction(ConvenienceBuilder.createWebsiteOnClickAction(c, Uri.parse("https://github.com/Johnmorales26")))
                .build());
        ...
        convenienceCardBuilder.addItem(ConvenienceBuilder.createWebsiteActionItem(c,
                ...
                "Visit Website",
                true,
                Uri.parse("https://johnmorales26.github.io/portafolio/html/index.html")));
        ...
        otherCardBuilder.cardColor(Color.parseColor("#a3b2c1"));
