package com.johndev.coupons.mainModule.viewModel
...
import com.johndev.coupons.common.utils.getMsgErrorByCode
import com.johndev.coupons.mainModule.model.MainRepository
        ...
        coupon.value?.let { couponEntity ->
            viewModelScope.launch {
                ...
                try {
                    ...
                    consultCouponByCode()
                    snackbarMsg.value = R.string.main_save_succsess
                } catch (e: Exception) {
