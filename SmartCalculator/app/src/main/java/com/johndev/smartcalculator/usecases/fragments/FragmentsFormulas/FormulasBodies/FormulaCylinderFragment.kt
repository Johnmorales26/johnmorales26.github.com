...
class FormulaCylinderFragment : Fragment() {

    private var _binding: FragmentFormulaCylinderBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFormulaCylinderBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val formulaArea = "$$ V = \\pi r^2 h $$"
