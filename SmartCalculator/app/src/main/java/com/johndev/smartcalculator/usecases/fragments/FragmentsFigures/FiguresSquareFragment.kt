...
class FiguresSquareFragment : Fragment() {

    private var _binding: FragmentFiguresSquareBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFiguresSquareBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnResult.setOnClickListener{
            if (validFields()){
                ...
                with(binding){
                    tvArea.text = figures.areaSquare(sideA)
                    tvPerimeter.text = figures.perimeterSquare(sideA)
                }
            }
        }
    }
