...
class FormulaTriangularPrismFragment : Fragment() {

    private var _binding: FragmentFormulaTriangularPrismBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFormulaTriangularPrismBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val formulaPerimetro = "$$ V = Dh $$"
