        ...
        when(theme) {
            getString(R.string.preference_key_color_default) -> {
                with(binding) {
                    ...
                    if (MainActivity.sharedPreferences.getBoolean(getString(R.string.key_preference_enable_light_mode), true)) {
                        containerFunctions.setBackgroundColor(getColor(R.color.primaryPurpleBackground))
                    }
                }
            }
            getString(R.string.preference_key_color_red) -> {
                with(binding) {
                    ...
                    if (MainActivity.sharedPreferences.getBoolean(getString(R.string.key_preference_enable_light_mode), true)) {
                        containerFunctions.setBackgroundColor(getColor(R.color.primaryRedBackground))
                    }
                }
            }
            getString(R.string.preference_key_color_yellow) -> {
                with(binding) {
                    ...
                    if (MainActivity.sharedPreferences.getBoolean(getString(R.string.key_preference_enable_light_mode), true)) {
                        containerFunctions.setBackgroundColor(getColor(R.color.primaryYellowBackground))
                    }
                }
            }
            getString(R.string.preference_key_color_blue) -> {
                with(binding) {
                    ...
                    if (MainActivity.sharedPreferences.getBoolean(getString(R.string.key_preference_enable_light_mode), true)) {
                        containerFunctions.setBackgroundColor(getColor(R.color.primaryBlueBackground))
                        //maincontainerFunctions.background.colorFilter = BlendModeColorFilterCompat.createBlendModeColorFilterCompat(getColor(R.color.primaryBlueBackground), BlendModeCompat.SRC_ATOP)
                    }
                }
            }
            getString(R.string.preference_key_color_green) -> {
                with(binding) {
                    ...
                    if (MainActivity.sharedPreferences.getBoolean(getString(R.string.key_preference_enable_light_mode), true)) {
                        containerFunctions.setBackgroundColor(getColor(R.color.primaryGreenBackground))
                    }
                }
            }
            ...
            getString(R.string.preference_key_color_orange) -> {
                with(binding) {
                    ...
                    if (MainActivity.sharedPreferences.getBoolean(getString(R.string.key_preference_enable_light_mode), true)) {
                        containerFunctions.setBackgroundColor(getColor(R.color.primaryOrangeBackground))
                    }
                }
            }
        }
